...
import create_workflow from "@assets/diagrams/request_flow/lottie/create_workflow.lottie";
...
<dotlottie-wc src="/src/assets/diagrams/request_flow/lottie/create_workflow.lottie"  style="height: 150px" aria-label="An animated diagram showing the request flow for workflow creation" role="img" autoplay loop></dotlottie-wc>
...
<dotlottie-wc src="/src/assets/diagrams/request_flow/lottie/upload_document.lottie" style="height: 150px" aria-label="An animated diagram showing the request flow for document upload and normalization" role="img" autoplay loop></dotlottie-wc>
...
<dotlottie-wc src="/src/assets/diagrams/request_flow/lottie/visualization.lottie" aria-label="An animated diagram showing the request flow for chunk visualization" role="img" autoplay loop></dotlottie-wc>
...
<dotlottie-wc src="/src/assets/diagrams/request_flow/lottie/evaluation.lottie" aria-label="An animated diagram showing the request flow for chunk evaluation" role="img" autoplay loop></dotlottie-wc>
...
<dotlottie-wc src="/src/assets/diagrams/request_flow/lottie/compare_workflows.lottie" style="height: 150px" aria-label="An animated diagram showing the request flow for workflow comparison" role="img" autoplay loop></dotlottie-wc>
...
<dotlottie-wc src="/src/assets/diagrams/request_flow/lottie/process_documents.lottie" aria-label="An animated diagram showing the request flow for deployment of the ingestion pipeline" role="img" autoplay loop></dotlottie-wc>
