...
import chunkwise from "@assets/logos/logo.svg";
import vectorize from "@assets/logos/vectorize.png";
import chonkie_and_unstructured from "@assets/logos/chonkie_and_unstructured.png";
...
<table>
  <thead>
    <tr>
      ...
      <th style="vertical-align: middle;">
        <Image
          src={chonkie_and_unstructured}
          width="150px"
          alt="Chonkie and Unstructured"
          style="display: block; margin: 0 auto;"
        />
      </th>
      <th style="vertical-align: middle; text-align: center;">DIY</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td>
        <strong>Open Source & Self-Managed</strong>
      </td>
      <td align="center">✓</td>
      <td align="center">✕</td>
      <td align="center">✕</td>
    ...
    <tr>
      <td>
        <strong>Built-In Platform</strong>
      </td>
      <td align="center">✓</td>
      <td align="center">✓</td>
      <td align="center">✓</td>
    ...
    <tr>
      <td>
        <strong>Chunk Visualization</strong>
      </td>
      <td align="center">✓</td>
      <td align="center">✕</td>
      <td align="center">✓</td>
    ...
    <tr>
      <td>
        <strong>Retrieval-Based Evaluation</strong>
      </td>
      <td align="center">✓</td>
      <td align="center">✓</td>
      <td align="center">✕</td>
    ...
    <tr>
      ...
      <td align="center">
        ⏤ <br>(limited support for data source and document formats)</br>
      </td>
      <td align="center">✓</td>
      <td align="center">✓</td>
      <td align="center">✓</td>
